...
CREATE TABLE "active_storage_blobs" ("id" uuid NOT NULL PRIMARY KEY, "key" varchar NOT NULL, "filename" varchar NOT NULL, "content_type" varchar, "metadata" text, "service_name" varchar NOT NULL, "byte_size" bigint NOT NULL, "checksum" varchar, "created_at" datetime(6) NOT NULL);
CREATE UNIQUE INDEX "index_active_storage_blobs_on_key" ON "active_storage_blobs" ("key") /*application='Daplanstan'*/;
CREATE TABLE "active_storage_attachments" ("id" uuid NOT NULL PRIMARY KEY, "name" varchar NOT NULL, "record_type" varchar NOT NULL, "record_id" uuid NOT NULL, "blob_id" uuid NOT NULL, "created_at" datetime(6) NOT NULL, CONSTRAINT "fk_rails_c3b3935057"
FOREIGN KEY ("blob_id")
...
CREATE TABLE "active_storage_variant_records" ("id" uuid NOT NULL PRIMARY KEY, "blob_id" uuid NOT NULL, "variation_digest" varchar NOT NULL, CONSTRAINT "fk_rails_993965df05"
FOREIGN KEY ("blob_id")
  REFERENCES "active_storage_blobs" ("id")
);
...
CREATE TABLE "action_mailbox_inbound_emails" ("id" uuid NOT NULL PRIMARY KEY, "status" integer DEFAULT 0 NOT NULL, "message_id" varchar NOT NULL, "message_checksum" varchar NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL);
...
CREATE TABLE "users" ("id" uuid NOT NULL PRIMARY KEY, "name" varchar NOT NULL, "email" varchar NOT NULL, "avatar_url" varchar, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, "theme" varchar DEFAULT 'midnight' NOT NULL /*application='Daplanstan'*/, "admin" boolean DEFAULT FALSE NOT NULL /*application='Daplanstan'*/);
CREATE UNIQUE INDEX "index_users_on_email" ON "users" ("email") /*application='Daplanstan'*/;
CREATE TABLE "user_identities" ("id" uuid NOT NULL PRIMARY KEY, "user_id" uuid NOT NULL, "provider" varchar NOT NULL, "provider_uid" varchar NOT NULL, "provider_email" varchar, "access_token" varchar, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, CONSTRAINT "fk_rails_684b0e1ce0"
FOREIGN KEY ("user_id")
  REFERENCES "users" ("id")
);
...
CREATE TABLE "approved_senders" ("id" uuid NOT NULL PRIMARY KEY, "trip_id" uuid NOT NULL, "email" varchar NOT NULL, "display_name" varchar, "approved_by_id" uuid NOT NULL, "approved_at" datetime(6) NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, CONSTRAINT "fk_rails_b5cb55a79b"
FOREIGN KEY ("trip_id")
  REFERENCES "trips" ("id")
...
CREATE TABLE "accounts" ("id" uuid NOT NULL PRIMARY KEY, "owner_id" uuid NOT NULL, "name" varchar NOT NULL, "subscription_status" varchar DEFAULT 'free' NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, CONSTRAINT "fk_rails_37ced7af95"
FOREIGN KEY ("owner_id")
  REFERENCES "users" ("id")
);
CREATE INDEX "index_accounts_on_owner_id" ON "accounts" ("owner_id") /*application='Daplanstan'*/;
CREATE TABLE "travelers" ("id" uuid NOT NULL PRIMARY KEY, "account_id" uuid NOT NULL, "user_id" uuid, "name" varchar NOT NULL, "email" varchar, "avatar_url" varchar, "invite_accepted_at" datetime(6), "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, CONSTRAINT "fk_rails_e9554b3429"
...
CREATE TABLE "trip_members" ("id"  NOT NULL PRIMARY KEY, "trip_id"  NOT NULL, "role" varchar DEFAULT 'viewer' NOT NULL, "joined_at" datetime(6), "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, "traveler_id"  NOT NULL, CONSTRAINT "fk_rails_ea64d876a7"
FOREIGN KEY ("trip_id")
  REFERENCES "trips" ("id")
...
CREATE TABLE "invites" ("id" uuid NOT NULL PRIMARY KEY, "token" varchar NOT NULL, "email" varchar, "note" varchar, "created_by_id" uuid NOT NULL, "used_by_id" uuid, "used_at" datetime(6), "expires_at" datetime(6), "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, CONSTRAINT "fk_rails_b52eeab183"
FOREIGN KEY ("created_by_id")
  REFERENCES "users" ("id")
...
CREATE TABLE "media_items" ("id"  NOT NULL PRIMARY KEY, "trip_id"  NOT NULL, "media_type" varchar NOT NULL, "caption" varchar, "taken_at" datetime(6), "latitude" decimal(10,6), "longitude" decimal(10,6), "uploaded_by_id"  NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, CONSTRAINT "fk_rails_c74185777c"
FOREIGN KEY ("trip_id")
  REFERENCES "trips" ("id")
